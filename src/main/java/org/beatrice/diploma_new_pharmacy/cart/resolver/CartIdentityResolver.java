package org.beatrice.diploma_new_pharmacy.cart.resolver;
...
public class CartIdentityResolver implements HandlerMethodArgumentResolver {
    ...
    public boolean supportsParameter(MethodParameter parameter) {
        return parameter.getParameterType().equals(CartIdentity.class);
    }
    ...
    public @Nullable Object resolveArgument(MethodParameter parameter,
        ...
        return CartIdentity.forGuest(guestUuid);
    }
}
